...
class GeneticAlgorithm:
    ...
    def optimize(self):
        ...
        for generation in range(self.num_generations):
            ...
            parents = self.select_best_individuals(population, fitness)
        ...
        self.optimal_solution = population[np.argmax(self.calculate_fitness(population))]
        self.optimal_value = self.func(self.optimal_solution)
        print("Y(x)max", self.optimal_value)
        print("Xmax:", self.optimal_solution)
    ...
    def plot_function(self):
        ...
        plt.scatter(self.optimal_solution, self.optimal_value, color='red', label='Максимум')
...
optimal_solution, optimal_value = ga.optimize()
ga.plot_function()
